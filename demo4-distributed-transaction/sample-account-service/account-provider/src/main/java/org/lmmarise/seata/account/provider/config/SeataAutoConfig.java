package org.lmmarise.seata.account.provider.config;
...
public class SeataAutoConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSourceProxy dataSourceProxy) {
        ...
        entityManagerFactoryBean.setPackagesToScan(Account.class.getPackage().getName());
...
//                .getResources("classpath*:xxx/mappers/*Mapper.xml"));
